...
def dataForm(form,data):
    ...
    if form == "monitoring":
        return {"version": "2.0","template": {"outputs": [{"basicCard": {"title": "모니터링","description": "원하시는 작업을 선택해주세요.","buttons": [{"action": "webLink","label": "작업상태","webLinkUrl": "https://jjjinypangmonitoring.s3.amazonaws.com/img.png"},{"action":  "webLink","label": "오케스트레이터","webLinkUrl": "https://154.10.6.152"}]}}]}}
    #if form == "screenshot":
    #    return {"version": "2.0","template": {"outputs": [{"basicCard": {"title": "모니터링 이동","description": "실시간 모니터링 상황을 확인해보세요.","buttons": [{"action":  "webLink","label": "작업내역","webLinkUrl": "https://jjjinypangmonitoring.s3.amazonaws.com/img.png"}]}}]}}
    if form == "listJob":
